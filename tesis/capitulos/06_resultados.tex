...
La Figura \ref{fig:diagnostico_primera_etapa} proyecta el valor real del EMBI+ contra su valor ajustado por la regresión de primera etapa (en función de $d_{t-1}$, la brecha del producto, el VIX y el EMBI$_{Brasil}$). La nube de puntos se ajusta razonablemente bien a la recta de 45 grados, consistente con el estadístico F de relevancia de 13.00.
