...
Frente a la ventana original (Tabla \ref{tab:descriptivos}), la incorporación de 1999--2003 desplaza sensiblemente los extremos: el mínimo de la deuda/PIB baja de 40.00\% a 26.96\% (el piso de la salida de la crisis, no capturado por la ventana original, que arranca ya en el proceso de descompresión posterior al canje) y su máximo sube de 119.00\% a 157.27\% (el pico del default de 2002, previo a la quita de 2005). El EMBI+ exhibe el mismo patrón: la media cae de 2416 a 1584 puntos básicos y la asimetría se acentúa (0.95 a 1.78), reflejando que el pico de riesgo soberano de la crisis de 2001--2002 --ausente en la ventana original, que comienza en 2004, ya en fase de descompresión-- es sustancialmente mayor al de cualquier episodio posterior. Estos desplazamientos no son un artefacto del empalme: son, precisamente, la señal sustantiva de incorporar los ``cambios estructurales extremos'' que motivaron el pedido de ampliar la ventana.
