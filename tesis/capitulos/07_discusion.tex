...
\section{Dominancia Estructural Cambiaria y Gestión de Pasivos (SVAR y CIR)}
\label{sec:implicancias_svar_cir}

La descomposición de varianza del SVAR Restringido (Sección \ref{sec:svar_resultados} del Capítulo \ref{ch:resultados}) aporta evidencia concluyente sobre el mecanismo de transmisión macrofiscal: los shocks cambiarios ($38.9\%$) y de riesgo soberano ($26.5\%$) explican casi dos tercios de la variabilidad de la deuda a horizontes de mediano plazo, frente a una contribución menor al $9\%$ del superávit primario propio. Este hallazgo empírico traslada el eje del debate de política pública: los esfuerzos de consolidación fiscal primaria, aunque necesarios para evitar la dominancia fiscal, son cuantitativamente insuficientes si no se encuentran acompañados de un esquema de estabilización macroeconómica que amortigüe los shocks cambiarios reales y contenga la volatilidad del riesgo país.
