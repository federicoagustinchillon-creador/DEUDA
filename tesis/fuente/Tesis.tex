...
% T1 obligatorio: bajo XeLaTeX, sin esto mathptmx busca sus variantes en
% codificacion TU (Unicode) donde no existen (p. ej. "TU/ptm/b/n undefined"),
% y LaTeX sustituye silenciosamente la negrita por texto regular. Con T1,
% mathptmx encuentra sus formas T1/ptm/b/n reales y \bfseries/\textbf
% funcionan en todo el documento (titulos de capitulo, leyendas en negrita).
...
\fancyhf{}
\fancyhead[C]{\includegraphics[height=0.9cm]{logo_fce_uncuyo.png}}
...
\input{../capitulos/03_marco_teorico}
\input{../capitulos/04_metodologia}
\input{../capitulos/05_datos}
