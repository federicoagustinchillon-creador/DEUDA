...
- **Tareas Cuantitativas & [[herc-hierarchical-equal-risk-contribution|HERC]]**: Consultar `herc-quant-engine-auditor` y `backtest-overfitting-pbo-guard`.
- **Macro & Vistas [[cfa-l3-asset-allocation-risk-budgeting|Black-Litterman]]**: Consultar `SecondBrain/core/macro_coyuntura/live_macro_views_registry.json`.
